...
async def generate_image(image_caption, dimensions=(1792, 1024)):
...
async def generate_cyoa(choice):
...
@app.route('/')
async def index():
    img_path = await generate_image("generate a picture that illustrates the concept of a choose your own adventure game")
